    ...
    return (
        <>
            ...
            <div>
                ...
                <span className="text-green-500 hover:text-green-300 cursor-pointer" onClick={applyExampleToken}>{EXAMPLE_TOKEN_ADDRESS}</span>
            </div>
        </>
    );
};
